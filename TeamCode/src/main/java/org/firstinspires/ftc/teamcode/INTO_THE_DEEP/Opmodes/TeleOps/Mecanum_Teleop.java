package org.firstinspires.ftc.teamcode.INTO_THE_DEEP.Opmodes.TeleOps;
...
import org.firstinspires.ftc.teamcode.INTO_THE_DEEP.Odometry.GoBildaPinpointDriver;
...
public class Mecanum_Teleop extends LinearOpMode {
    ...
    private static final int ARM_POSITION_INTAKE = 250;
    private static final int ARM_POSITION_WALL_GRAB = 4400;
    private static final int ARM_POSITION_WALL_UNHOOK = 1200;
    private static final int ARM_POSITION_HOVER_HIGH = 1700;
    private static final int ARM_POSITION_CLIP_HIGH = 2300;
    private static final int ARM_POSITION_LOW_BASKET = 1550;


    private static final int WRIST_POSITION_INIT = 0;
    private static final int WRIST_POSITION_SAMPLE = 240;
    private static final int WRIST_POSITION_SPEC = 0;



    // Claw positions
    private static final double CLAW_OPEN_POSITION = 0.52;
